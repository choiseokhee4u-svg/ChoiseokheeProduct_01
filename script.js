...
const E = {
    WOOD: { img: 'images/Wood.png', c: '#4ade80' },
    FIRE: { img: 'images/Fire.png', c: '#f87171', style: 'filter: invert(1) hue-rotate(180deg);' },
    EARTH: { img: 'images/Earth.png', c: '#fbbf24', style: 'filter: invert(1) hue-rotate(180deg);' },
    METAL: { img: 'images/Metal.png', c: '#e2e8f0', style: 'filter: invert(1) hue-rotate(180deg);' },
    WATER: { img: 'images/Water.jpg', c: '#60a5fa', style: 'filter: invert(1) hue-rotate(180deg);' }
};
